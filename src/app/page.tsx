        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-4">
            <p className="text-base text-gray-700 leading-relaxed">
              Menfem is a new media and product holding company focused on
              lifestyle, culture, and design and product. We curate high-quality
              content and experiences tailored across arts, film, fashion, and
              style. Our goal is to build and help acquire enduring consumer
              brands, with a strong emphasis on design, storytelling, and
              community.
            </p>

            <p className="text-sm text-gray-600 leading-relaxed">
              We aim to build a growing portfolio of niche sub-brands that serve
              distinct audiences. Beyond digital content, we create in-person
              experiences and events to foster meaningful consumer networks. We
              believe in developing thoughtful products and immersive
              touchpoints that turn audiences into communities — and communities
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <Link href="/culture" className="group">
            <div className="bg-brand-cream p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Film, music, literature, and cultural commentary for the modern
                man.
              </p>
            </div>
          </Link>
          ...
          <Link href="/the-list" className="group">
            <div className="bg-brand-cream p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Weekly curated recommendations of what&#39;s worth your
                attention.
              </p>
            </div>
          </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="text-gray-700 hover:text-brand-terracotta transition-colors"
                >
                  Instagram
                </a>
                <a
